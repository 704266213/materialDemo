 ...
 * 类的描述：
 * 创建人：alan
 * 创建时间：2016/8/12 18:56
 */
public class NestedScrollingTextView extends TextView implements NestedScrollingChild {

    private NestedScrollingChildHelper mNestedScrollingChildHelper;

    public NestedScrollingTextView(final Context context) {
        super(context);
        initHelper();
    }

    public NestedScrollingTextView(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        initHelper();
    }

    public NestedScrollingTextView(final Context context, final AttributeSet attrs, final int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initHelper();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public NestedScrollingTextView(final Context context, final AttributeSet attrs, final int defStyleAttr, final int defStyleRes) {
